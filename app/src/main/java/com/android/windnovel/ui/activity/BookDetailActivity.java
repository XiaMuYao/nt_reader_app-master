...
import com.android.windnovel.presenter.BookDetailPresenter;
...
import com.android.windnovel.ui.adapter.HotCommentAdapter;
    ...
    protected void initClick() {
        ...
        if (mBookListAdapter != null) {
            mBookListAdapter.setOnItemClickListener(
                    (view, pos) -> {
                        String bookId = mBookListAdapter.getItem(pos).get_id();
